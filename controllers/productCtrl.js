...
class APIfeatures {
    ...
    sorting(){
        if(this.queryString.sort) {
            ...
            // console.log(sortBy); // price = ascendent ; -price = descendent
    ...
    paginating(){
        ...
        const limit = this.queryString.limit * 1 || 9; // min || max limits
...
const productCtrl = {
    ...
    createProduct: async(req, res) => {
        try {
            ...
            if(!images) {
                return res.status(400).json({msg: "Nao há upload de imagem"});
            }
